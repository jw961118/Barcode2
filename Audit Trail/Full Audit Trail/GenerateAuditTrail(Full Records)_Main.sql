...
CREATE PROCEDURE [dbo].[GenerateAuditTrail]
	...
	@AuditNameExtention varchar(128) = '_TR',
...
BEGIN
	...
	BEGIN
		...
		SET @CreateStatement = @CreateStatement + 'CONSTRAINT [DF_' + @TableName + @AuditNameExtention + '_AuditUser] DEFAULT (host_name()) FOR [AuditUser],CONSTRAINT [PK_' + @TableName + @AuditNameExtention + '] PRIMARY KEY  CLUSTERED '
